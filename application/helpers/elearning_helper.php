...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        'base_url'          => base_url(),
        'site_url'          => site_url(),
        'favicon_url'       => base_url('assets/images/logo-sekolah.png'),
        'copyright_setup'   => 'Copyright - ' . date('Y') . ' Uswatun Khasanah',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright ' . date('Y') . ' - ' . get_pengaturan('nama-sekolah', 'value').' (by Uswatun Khasanah)';
